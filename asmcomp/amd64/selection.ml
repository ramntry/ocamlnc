...
method override select_store addr exp =
  match exp with
...
method override select_operation op args =
  match op with
...
method override insert_op_debug op dbg rs rd =
  try
...
method override insert_op op rs rd =
