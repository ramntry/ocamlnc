...
module Parsetree : sig
  ...
  | Ptyp_poly (list, c1) -> T.Ptyp_poly (list, core_type c1)
      | Ptyp_package p -> 
          raise (No_Such_Feature (this_version, "type package"))
...
and expression_desc e =
  ...
  | Pexp_newtype (s, e) -> 
      raise (No_Such_Feature (this_version, "newtype"))
  | Pexp_pack m -> 
      raise (No_Such_Feature (this_version, "package expression"))
  | Pexp_open (l, e) -> 
      raise (No_Such_Feature (this_version, "let open"))
...
and module_type_desc m =
  ...
  | Pmty_typeof me -> 
      raise (No_Such_Feature (this_version, "module type of"))
...
and with_constraint w =
  ...
  | Pwith_typesubst t -> 
      raise (No_Such_Feature (this_version, 
          "with type :="))
  | Pwith_modsubst l -> 
      raise (No_Such_Feature (this_version,
          "with module :="))
...
and module_expr_desc me =
  ...
  | Pmod_unpack _ ->
      raise (No_Such_Feature (this_version, "unpack package"))
